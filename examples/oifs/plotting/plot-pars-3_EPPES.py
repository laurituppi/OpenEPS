...
mu_data[0] = np.loadtxt("/wrk/lautuppi/DONOTREMOVE/init_mu_sigma/mufile_2par.dat")
sig_data = np.zeros((ndays+1, npars, npars))
sig_data[0] = np.loadtxt("/wrk/lautuppi/DONOTREMOVE/init_mu_sigma/sigfile_2par.dat")
